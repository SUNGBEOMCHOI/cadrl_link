...
namespace osm_planner {
   ...
   void Parser::initialize(){
       ...
       position_marker_pub = n.advertise<visualization_msgs::Marker>("position_marker", 1);
       target_marker_pub = n.advertise<visualization_msgs::Marker>("target_marker", 1);

       path_pub = n.advertise<nav_msgs::Path>("route_network", 1);
       refused_path_pub = n.advertise<nav_msgs::Path>("refused_path", 1);
